...
Original file is located at
    https://colab.research.google.com/drive/1O9iYjVL9H-0tsZBk2jQvkUd39XcmJvSK
...
# Violations by Precinct in 2020
...
violation_by_code = violation_by_code.join(dataset_vd, dataset_vd[violation_code] == violation_by_code[violation_code]).select(dataset_vd[violation_description], violation_by_code["count"], violation_by_code[violation_code]).orderBy(violation_description)
